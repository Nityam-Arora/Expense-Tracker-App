...
public class DailyFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        expenseViewModel.getAllExpenses().observe(getViewLifecycleOwner(), allExpenses -> {
            adapter = new ExpenseAdapter(getContext(), allExpenses, ExpenseAdapter.TYPE_DAILY_FRAGMENT);
